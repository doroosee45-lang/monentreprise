...
//   const links = {
//     Services: [
//       { to: '/services', label: 'Réseau & Infrastructure' },
//       { to: '/services', label: 'Sécurité IT' },
//       { to: '/services', label: 'Développement Digital' },
//       { to: '/services', label: 'Cloud & Hébergement' },
//       { to: '/services', label: 'Énergie Solaire' },
//     ],
//     Solutions: [
//       { to: '/solutions', label: 'Pack Entreprise' },
//       { to: '/solutions', label: 'Pack E-commerce' },
//       { to: '/solutions', label: 'Pack Digital Complet' },
//       { to: '/solutions', label: 'Pack Énergie Solaire' },
//       { to: '/solutions', label: 'Pack Formation' },
//     ],
//     Entreprise: [
...
//               <span style={{ fontFamily: 'var(--font-display)', fontWeight: 800, fontSize: 22 }}>OMDEVE</span>
//             </div>
//             <p style={{ color: 'var(--gray-400)', fontSize: 14, lineHeight: 1.7, marginBottom: 24, maxWidth: 260 }}>
//               Votre partenaire de confiance en solutions IT, digitales et énergétiques à Kinshasa, RDC.
//             </p>
//             <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
//               {[
//                 { icon: '📍', text: 'Kinshasa, République Démocratique du Congo' },
//                 { icon: '📞', text: '+243 XXX XXX XXX' },
//                 { icon: '✉️', text: 'info@omdeve.com' },
//               ].map((c, i) => (
//                 <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 10, color: 'var(--gray-400)', fontSize: 13 }}>
...
//             <div key={title}>
//               <h4 style={{ fontFamily: 'var(--font-display)', fontSize: 14, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--primary)', marginBottom: 16 }}>{title}</h4>
//               <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 10 }}>
//                 {items.map((l) => (
//                   <li key={l.label}>
//                     <Link to={l.to} style={{ color: 'var(--gray-400)', fontSize: 14, transition: 'color 0.2s' }}
...
//         {/* CTA Banner */}
//         <div style={{ background: 'linear-gradient(135deg, rgba(0,194,255,0.12), rgba(0,194,255,0.04))', border: '1px solid rgba(0,194,255,0.2)', borderRadius: 16, padding: '32px 40px', marginBottom: 40, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 24, flexWrap: 'wrap' }}>
//           <div>
//             <h3 style={{ fontFamily: 'var(--font-display)', fontSize: 22, marginBottom: 6 }}>Prêt à transformer votre infrastructure ?</h3>
//             <p style={{ color: 'var(--gray-400)', fontSize: 14 }}>Obtenez votre audit gratuit ou demandez un devis personnalisé dès maintenant.</p>
//           </div>
//           <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
//             <Link to="/audit" className="btn btn-outline btn-sm">Audit gratuit</Link>
//             <Link to="/devis" className="btn btn-primary btn-sm">Demander un devis →</Link>
//           </div>
//         </div>

//         {/* Bottom bar */}
//         <div style={{ borderTop: '1px solid rgba(255,255,255,0.08)', padding: '20px 0', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 12 }}>
//           <p style={{ color: 'var(--gray-500)', fontSize: 13 }}>© {year} OMDEVE. Tous droits réservés.</p>
//           <div style={{ display: 'flex', gap: 20 }}>
//             {['Confidentialité', 'Conditions', 'Mentions légales'].map(l => (
//               <Link key={l} to="#" style={{ color: 'var(--gray-500)', fontSize: 13 }}>{l}</Link>
//             ))}
//           </div>
//         </div>
//       </div>
